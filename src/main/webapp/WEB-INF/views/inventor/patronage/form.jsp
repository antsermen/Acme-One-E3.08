...
<acme:form >
	...
	<acme:button test="${acme:anyOf(command, 'show') && status != 'PROPOSED'}" code="inventor.patronageReport.list.button.create" action="/inventor/patronage-report/create?id=${patronageId}"/> 	
