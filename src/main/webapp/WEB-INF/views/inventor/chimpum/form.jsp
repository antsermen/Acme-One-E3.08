...
<acme:form readonly="${readonly}">
	...
	<acme:input-textbox code="inventor.chimpum.form.label.itemName" path="itemCode" readonly="true"/>	
	...
	<acme:input-textbox code="inventor.chimpum.form.label.initialPeriod" path="initialPeriod"/>
	<acme:input-textbox code="inventor.chimpum.form.label.finalPeriod" path="finalPeriod"/>
